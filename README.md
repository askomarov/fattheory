...
обработка масла раствором пищевой кислоты (как правило, лимонной), для перевода негидратирующих фосфатидов в гидратирующую форму, с дальнейшей обработкой водой. Такие фосфатиды непригодны, для получения лецитина, т.к содержат больше фосфатидных кислот и гидратирующую кислоту.
...
EnzyMax – применяют фосфолипазу – фосфолипиды превращаются в лизофосфолипиды и свободные ЖК. Применим для большинства масел, кроме хлопкового и кукурузного.
### Кислотная рафинация 
