...
- [Методы очистки.Физическая рафинация](#physical-refining)
- [Химическая рафинация](#chemical-refining)
- [Характеристики плавления, затвердевания и консистенции](#3.3)
- [Характеристики состава](#3.4)
- [Вкус и запах, окислительная порча и стабильность](#3.5)
...
### Подготовленные масличные семена обрабатываются одним из процессов:
...
### <a name="physical-refining"></a> Физическая рафинация - 
...
(Стр 56 в книге)
### <a name="chemical-refining"></a> Химическая рафинация
...
## 3.3 <a name="3.3"></a> Характеристики плавления, затвердевания и консистенции
...
## 3.4 <a name="3.4"></a> Характеристики состава
### Число омыления
...
## 3.5 <a name="3.5"></a> Вкус и запах, окислительная порча и стабильность

---

# <a name="emulsifier"></a> Эмульгаторы (Обрайн стр 179)
...
# <a name="emul"></a> Эмульсии
![изобржание двух типов эмульсий](emulgator.jpg)

Эмульсия состоит из двух несмешивающихся жидкостей, одна из которых диспергирована в другой в виде небольших сферических капель. Система, состоящая из капель масла, диспергированных в водной фазе, называется эмульсией типа масло-в-воде (молоко, сливки, майонез, супы, соусы). Система, из капель в воды, диспергированных в жировой фазе, называется эмульсией типа вода-в-масле (маргарин, сливочное масло).
Вещество внутри частиц – дисперсная или внутренняя фаза, а вещество окружающее – дисперсионная иои внешняя фаза.
Возможно создание сложных эмульсий, типа масло-в-воде-в-масле или вода-в-масле-в-воде.
> Гомогенизацией эмульсии – называется процесс уменьшения размера капель дисперсной фазы в этой эмульсии.
## Устойчивость эмульсий
Потеря устойчивости может быть обусловленная различными физико-химическими процессами - действие гравитационного поля, флокуляция, коалесценция, частичная коалесценция, созревание Оствальда и инверсия фаз.
- Под действием гравитации происходит *седиментация* – частицы дисперсной фазы опускаются вниз или верхняя седиментация – процесс перемещения частиц дисперсной фазы вверх.
- *Флокуляция* (образование хлопьев) -  процесс склеивания двух или более капель с образованием агрегата, в котором капли сохраняют свою целостность.
- *Коалесценция* – процесс, при котором две или более капель в результате слияния образуют одну более крупную
- *Созревание Оствальда* – рост более крупных капель за счет более мелких, происходящий благодаря переносу массы вещества дисперсной фазы через дисперсную среду.
- *Инверсия фаз* – эмульсия одного типа, превращается в другой, например масло-в-воде в вода-в-масле.
